  ...
  <StrictMode>
    <OneColumnLayout maxWidth="60ch">
      ...
      <figure className="flex flex-col justify-center items-center">
        <img className="h-[240px]" src="https://www.stthomas.edu/_media-library/_images/campus-safety/stthomas-parking-transportation-lot.jpg" alt="Outdoor Parking lot" />
        <figcaption className="mx-auto">
          <a href="https://www.stthomas.edu/_media-library/_images/campus-safety/stthomas-parking-transportation-lot.jpg">Image from the University of St. Thomas in Minnesota</a>
        </figcaption>
      </figure>
      ...
      <p>
        ...
        these spots can be filled very fast. In a parking garage, usually all of the parking spots
        on the first floor are all filled, because no one likes walking a shit
        ton to their class.
      </p>
      ...
      <p>When you drive around a parking lot, if you see more than one car exiting the parking lot, then that parking lot must be full, because no one likes to spend lots of time driving around in a parking lot.</p>
      ...
      <p>
        ...
        or December and the heat goes crazy in August and September. You're driving to campus and on the way your head and back are sweating like crazy and now you have to go to class sweaty. Here's how you prevent that
        terrible situation from happening.
      </p>

      <h3>Bring a fan to cool yourself off</h3>
      <figure className="flex flex-col justify-center items-center">
        <img className="h-[240px]" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fmedia.printables.com%2Fmedia%2Fprints%2F609926%2Fimages%2F6973189_1c055628-31cb-45d7-a538-e7ff67e6d868_f66bd8a6-beb5-4ef9-ae3a-56f099aa88ee%2Fimg-3.jpg&f=1&nofb=1&ipt=bd36663e812dd8ec5dafa129c86daeb91fe539708725fda887999626232f121c" alt="A handheld fan is standing up on a table with a smartphone leaning against it" />
      </figure>
      <p>If you do sweat a lot and it's unfessible for you to take a shower, because you're on campus then just hold fan and blow cool air on wherever you're sweating so you can cool off faster.</p>
      <h3>Bring towels with you to wipe off sweat</h3>
      <figure className="flex flex-col justify-center items-center">
        <img className="h-[240px]" src="https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fpngimg.com%2Fuploads%2Ftowel%2Ftowel_PNG5.png&f=1&nofb=1&ipt=507fb9ff0a65151316ab7d4bd39e8e9cd6f5df72d5c9be378d9a9797bb368359" alt="A neatly folded up orange towel" />
      </figure>
      <p>When you're driving in a car in hot weather, your head and back may sweat a lot, so having a towel on hand to wipe off the sweat is useful.</p>
    </OneColumnLayout>
  </StrictMode>,
);

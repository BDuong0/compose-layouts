      ...
      <FullScreenHero rowGap="8px">
        ...
        <FullScreenHero.FullSection className="bg-green-500">
          ...
          <p>
            ...
            Perspiciatis expedita assumenda commodi numquam adipisci rem
            praesentium dolores, modi possimus enim mollitia voluptas aperiam
            unde labore velit ut earum! Porro, consequatur.
          </p>
        </FullScreenHero.FullSection>
      </FullScreenHero>
    </main>
